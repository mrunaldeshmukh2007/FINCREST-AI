        ...
        <div className="relative z-10 max-w-md text-white">
          ...
          >
            ...
            <p className="mt-4 text-slate-400">
              Your AI has been analyzing your spending while you
              were away. Let&apos;s see what it found.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4 flex gap-2 items-end h-[90px]">
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        ...
        >
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              type="button"
              className="glass rounded-2xl py-3 text-sm font-semibold flex items-center justify-center gap-2 hover:bg-white/5 transition-colors"
              style={{ color: 'var(--text-primary)' }}
            >
              <svg
                className="w-5 h-5"
