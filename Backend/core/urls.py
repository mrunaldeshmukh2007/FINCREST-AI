...
urlpatterns = [
    ...
    path('transactions/streak/', transaction_streak),
    path('transactions/days-active/', days_active),
    path('transactions/achievements/', get_achievements),
